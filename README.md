...
**Languages.** A welcome and a keypad menu play first — "Welcome to the Amadeus
help desk. For English, press 1. Pour le français, appuyez sur le 2. Para
español, pulse 3." — and the desk opens in
...
`DESK_LANGUAGE`. Twilio speaks the menu, so the model's meter only starts once
